...
public class ChiSoNuocController {
    ...
    public ChiSoNuocController(JTextField jTextField_MaKH, JTextField jTextField_TenKH, JTextArea jTextArea_DiaChi, JTextField jTextField_soDienThoai, JTextField jTextField_TimKiem, JScrollPane jScrollPane_ChiSoDien, JButton jButton_GhiDien, JButton jButton_ThemThang, JScrollPane jScrollPane_KhachHang) {
    ...
    private final chiSoNuocDAOlmpl chiSoDienServiceImpl = new chiSoNuocDAOlmpl();
    ...
    private void refreshjTable_ChiSoDien(int maKH){
        ...
        List<List<Object>> obj = new ArrayList<>();
        List<ChiSoNuoc> list = chiSoDienServiceImpl.getList();
        list.forEach(csd -> {
            if (csd.getMaKH() == maKH){
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && jTable_ChiSoDien.getSelectedRow() != -1) {
                   ...
                   // selectedRowIndex = table.convertColumnIndexToModel(selectedRowIndex);
                    ...
                    ChiSoNuoc chiSoDien = chiSoDienServiceImpl.getChiSoDien(maKH, thangID);
