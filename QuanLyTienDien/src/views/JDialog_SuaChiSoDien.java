...
import services.ChiSoNuocServicelmpl;
...
public class JDialog_SuaChiSoDien extends javax.swing.JDialog {
     ...
     */
    private final ChiSoNuocServicelmpl chiSoDienServiceImpl = new ChiSoNuocServicelmpl();
    
    private final KhachHang khachHang;
    private final ChiSoNuoc chiSoDien;
    
    public JDialog_SuaChiSoDien(KhachHang khachHang, ChiSoNuoc chiSoDien) {
    ...
    private void initView(){
        ...
        ChiSoNuoc chiSoDienFirst = chiSoDienServiceImpl.getFirstChiSoDien(khachHang.getMaKH());
    ...
    private void updateChiSoDien(){
        ChiSoNuoc chiSoDienUpdate_1 = new ChiSoNuoc(chiSoDien.getId(), chiSoDien.getMaKH(), chiSoDien.getThangID(),
                Integer.parseInt(jTextField_ChiSoCu.getText()),
                Integer.parseInt(jTextField_ChiSoMoi.getText()), new Date());

        ChiSoNuoc chiSoDienUpdate_2 = chiSoDienServiceImpl.getChiSoDien(khachHang.getMaKH(), chiSoDien.getThangID() + 1);
    ...
    private boolean validChiSo(String chiSoCu_text, String chiSoMoi_text){
        try{
            ...
            ChiSoNuoc chiSoDienSau = chiSoDienServiceImpl.getChiSoDien(khachHang.getMaKH(), chiSoDien.getThangID() + 1);
    ...
    private void initComponents() {
        ...
        jPanel_Data.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Quản lý khách hàng", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 24))); // NOI18N
