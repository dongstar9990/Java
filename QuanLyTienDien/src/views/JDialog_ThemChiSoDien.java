...
public class JDialog_ThemChiSoDien extends javax.swing.JDialog {
     ...
     */
    private final chiSoNuocDAOlmpl chiSoDienDAOImpl = new chiSoNuocDAOlmpl();
    ...
    private void initView(){
        ...
        ChiSoNuoc chiSoDienLast = chiSoDienDAOImpl.getLastChiSoDien(khachHang.getMaKH());
    ...
    private void addChiSoDien(){
        ChiSoNuoc chiSoDienInsert = new ChiSoNuoc(0, khachHang.getMaKH(), thang.getThangID(),
    ...
    private boolean validChiSo(String chiSoCu_text, String chiSoMoi_text){
        try{
            ...
            if (thang != null){
                ChiSoNuoc chiSoDienSau = chiSoDienDAOImpl.getChiSoDien(khachHang.getMaKH(), thang.getThangID());
    ...
    private void initComponents() {
        ...
        jPanel_Data.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thêm chỉ số điện", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
